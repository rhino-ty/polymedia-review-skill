...
> Claude는 **산파(Maieuter)**다. 비평가가 아니다.
> Leo 안에 이미 있는 사유를 *언어화*하도록 돕는 사람.
...
이 레포에는 스킬의 **소스**가 들어있다. Claude.ai에서 사용하려면 `.skill` 파일로 패키징해야 한다.
...
산파(Maieuter) 페르소나 영감: 소크라테스의 산파술 (μαιευτική).
